...
const SUMMARY =
  'Full Stack Software Engineer with experience building AI-first products and scalable web applications from scratch. Founding team member at an early-stage startup, owning end-to-end frontend architecture and AI-driven workflows. Strong expertise in React, TypeScript, Node.js, Python, and microservice-based systems, with hands-on experience in real-time streaming (SSE), RAG pipelines, and agentic systems. Passionate about building high-impact products in fast-paced environments.';
...
const LandingIntro = () => {
  ...
  const landingIntroContent = {
    ...
    summary: SUMMARY,
    locationLine: 'Gurugram, India · +91 8340711366',
    cta: 'View My Work',
    socialLinks: [
      {
        platform: 'GitHub',
  ...
  return (
    <div className={styles.LandingIntroContainer}>
      ...
      <div className={styles.ContentOverlay}>
        ...
        <div className={styles.Tagline}>{landingIntroContent.tagline}</div>
        <div className={styles.LocationLine}>{landingIntroContent.locationLine}</div>
        <div className={styles.Summary}>{landingIntroContent.summary}</div>
        <button
